...
function keyboardControlCallback(msg)
    ...
    lastCommand = (lastCommand +1)%102441024
    end
...
if (sim_call_type == sim.syscb_init) then 
    ...
    -- ROS TOPOCS
        ...
        KEYBOARD_TOPIC           = "/cmd_vel_mux/input/teleop"
        
        -- subscribe to keyboard control topic
        keboardControlCommand  = simROS.subscribe(KEYBOARD_TOPIC, 'geometry_msgs/Twist',  'keyboardControlCallback', 1)
